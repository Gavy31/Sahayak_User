...
class AssistantMethods
{
  ...
  {
    double distanceperhunderedmeter = (directionDetailsInfo.duration_value!/100 ) ;
    double distancefare=0;
    if(distanceperhunderedmeter<=2){
      distancefare=20;
    }
    else if(distanceperhunderedmeter>2 && distanceperhunderedmeter<=5){
      distancefare=20 + 8 * distanceperhunderedmeter;
    }
    //USD
    double totalFareAmount = distancefare;

    return double.parse(totalFareAmount.toStringAsFixed(1));
  }

  static sendNotificationToPorterNow(String deviceRegistrationToken, String userRideRequestId, context) async
  {
