...
class SelectNearestActivePortersScreen extends StatefulWidget
{
  DatabaseReference? referenceRideRequest;

  SelectNearestActivePortersScreen({this.referenceRideRequest});

  @override
  _SelectNearestActivePortersScreenState createState() => _SelectNearestActivePortersScreenState();
}



class _SelectNearestActivePortersScreenState extends State<SelectNearestActivePortersScreen>
{
  String fareAmount = "";
      ...
      body: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index)
        {
          return GestureDetector(
            ...
            {
              setState(() {
                chosenPorterId = dList[index]["id"].toString();
              });
              Navigator.pop(context, "porterChoosed");
            },
            child: Card(
              color: Colors.grey,
              elevation: 3,
              ...
              child: ListTile(
                ...
                title: Column(
                  ...
                  children: [
                    ...
                    Text(
                      dList[index]["porter_details"]["station"],
                      style: const TextStyle(
                        fontSize: 12,
